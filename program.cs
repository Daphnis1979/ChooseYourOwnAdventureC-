      ...
      static void Main(string[] args)
    {
      ...
      Console.WriteLine($"Hello, {name}! Welcome to our story.");
        ...
        else if (noiseChoice == "YES")
        {
          ...
          if (doorChoice == "KNOCK")
          {
            Console.WriteLine("A voice behind the door speaks. It says, \"Answer this riddle: \"");Console.WriteLine("\"Poor people have it. Rich people need it. If you eat it you die. What is it?\"");
            Console.Write("Type your response: ");
            string riddleAnswer = Console.ReadLine().ToUpper();
             
            if (riddleAnswer == "NOTHING")
            {
              Console.WriteLine("he door opens and NOTHING is there.");
